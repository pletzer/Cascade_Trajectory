    ...
    IF (rand >= prob_total) THEN
      ...
      DO na=0,N
        DO nb=0,N
          ...
          DO m=1,3
            k1(nplace + m) = dot_product(H_full(m,:), &
      ...
      DO na=0,N
        DO nb=0,N
          ...
          ! Matrix multiplication
          DO m=1,3
            k2(nplace + m) = dot_product(H_full(m,:), &
                           &  psi_clone(nplace + 1:nplace + 3) + &
      ...
      DO na=0,N
        DO nb=0,N
          ...
          ! Matrix multiplication
          DO m=1,3
            k3(nplace + m) = dot_product(H_full(m,:), &
                           &  psi_clone(nplace + 1:nplace + 3) + &
      ...
      DO na=0,N
        DO nb=0,N
          ...
          ! Matrix multiplication
          DO m=1,3
            k4(nplace + m) = dot_product(H_full(m,:), &
                           & psi_clone(nplace + 1:nplace + 3) + &
